...
namespace Coling.Repositorio
    {
        public class conexion
        {
            ...
            {
            get { return @"Data Source=LAPTOP-211PH298\ACER; Initial Catalog=ColingSecurityBD; Integrated Security=True; TrustServerCertificate=true;"; }               //get { return ConfigurationManager.ConnectionStrings["cadena"].ToString(); }
        }
