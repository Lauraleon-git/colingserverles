...
namespace Coling.API.Curriculum.EndPoints
{
    public class InstitucionFunction
    {
        ...
        public async Task<HttpResponseData> EliminarInstitucion([HttpTrigger(AuthorizationLevel.Function, "delete")] HttpRequestData req,string partitionkey,string rowkey)
        {
            HttpResponseData respuesta;
            try
            {
